...
def fetch_teams(self):
    ...
    try:
        created, updated = sync_teams(settings.EPL_CURRENT_SEASON)
...
def fetch_fixtures(self):
    ...
    try:
        created, updated = sync_matches(settings.EPL_CURRENT_SEASON)
...
def fetch_standings(self):
    ...
    try:
        created, updated = sync_standings(settings.EPL_CURRENT_SEASON)
