    ...
    def get(self, request, match_slug):
        ...
        if offset > 0:
            html = render_to_string(
                "epl_discussions/partials/comment_page.html", context, request=request
            )
        else:
            html = render_to_string(
                "epl_discussions/partials/comment_list.html", context, request=request
            )
...
class CreateCommentView(LoginRequiredMixin, View):
    def post(self, request, match_slug):
        ...
        if not form.is_valid():
            html = render_to_string(
                "epl_discussions/partials/comment_form.html",
        ...
        html += render_to_string(
            "epl_discussions/partials/comment_count_oob.html",
