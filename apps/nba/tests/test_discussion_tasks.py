...
from discussions.tasks import generate_postgame_comments, generate_pregame_comments
...
def mock_claude():
    ...
    with patch("discussions.tasks._generate_comment_body") as mock:
...
class TestGeneratePregameComments:
    def test_creates_comments_for_scheduled_games(self, mock_claude):
        ...
        with patch("discussions.tasks.roll_action", return_value=True):
    ...
    def test_skips_when_roll_fails(self, mock_claude):
        ...
        with patch("discussions.tasks.roll_action", return_value=False):
            result = generate_pregame_comments()
    ...
    def test_respects_max_comments_cap(self, mock_claude):
        ...
        with (
            patch("discussions.tasks.roll_action", return_value=True),
            patch("discussions.tasks.get_active_window") as mock_window,
        ):
