...
class MyBetsView(LoginRequiredMixin, View):
    def get(self, request):
        ...
        if getattr(request, "htmx", False):
            return render(request, "betting/partials/bet_list.html", ctx)
        return render(request, "betting/my_bets.html", ctx)
...
class AddToParlayView(LoginRequiredMixin, View):
    def post(self, request):
        ...
        if getattr(request, "htmx", False):
            return render(request, "betting/partials/parlay_slip.html")
...
class PlaceParlayView(LoginRequiredMixin, View):
    def post(self, request):
        ...
        if getattr(request, "htmx", False):
            return render(
                request, "betting/partials/parlay_confirmation.html", {"parlay": parlay}
            )
