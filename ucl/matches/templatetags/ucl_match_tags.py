...
@register.inclusion_tag("ucl_matches/partials/status_badge.html")
def ucl_status_badge(match):
    return {"match": match}


@register.inclusion_tag("ucl_matches/partials/score_display.html")
def ucl_score_display(match):
    return {"match": match}


@register.filter
def ucl_result_label(match, team):
...
def ucl_is_today(context, match):
