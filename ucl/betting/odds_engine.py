"""House odds generation for UCL 1X2 markets."""
...
from ucl.matches.models import Match, Odds, Standing
...
def _team_strength(team):
    """Derive team strength from league phase standings. Higher = better."""
...
def generate_all_upcoming_odds():
    """Generate house odds for all upcoming UCL matches."""
