...
from nba.betting.tasks import _odds_changed, generate_odds, settle_pending_bets
...
class TestGenerateOddsTask:
    @patch("nba.betting.tasks.generate_all_upcoming_odds")
    def test_creates_new_odds_records(self, mock_generate):
        ...
        with patch("nba.activity.services.queue_activity_event"):
            generate_odds()
    ...
    @patch("nba.betting.tasks.generate_all_upcoming_odds", return_value=[])
    ...
    def test_queues_activity_event_when_odds_created(self, mock_generate):
        ...
        with patch("nba.activity.services.queue_activity_event") as mock_queue:
            generate_odds()
