"""
Compatibility wrapper around vinosports.betting.balance for NBA services.

The original nba-bets log_transaction(user, amount, type, desc) handles locking
internally. The vinosports-core version requires the caller to lock first.
This wrapper preserves the simpler API for easier porting.
"""
