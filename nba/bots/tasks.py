...
def generate_bot_reply_task(bot_user_id, game_id, parent_comment_id):
    ...
    from nba.bots.comment_service import generate_bot_comment
    from nba.discussions.models import Comment as DiscussionComment
    ...
    try:
        parent = DiscussionComment.objects.select_related("user", "parent").get(
...
def maybe_reply_to_human_comment(comment_id):
    ...
    from nba.bots.comment_service import select_reply_bot
    from nba.discussions.models import Comment as DiscussionComment
    ...
    delay = random.randint(60, 300)  # 1-5 min stagger (snappier than EPL)
